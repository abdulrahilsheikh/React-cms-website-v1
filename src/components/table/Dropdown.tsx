...
export function DropdownMenuDemo({ buttonComponent }: any) {
  return (
    <DropdownMenu>
      <DropdownMenuTrigger asChild>
        {buttonComponent ? buttonComponent : <button>Open</button>}
      </DropdownMenuTrigger>
      <DropdownMenuContent className="w-56 bg-white">
        ...
        <DropdownMenuGroup>
          ...
          <DropdownMenuItem>
            ...
            <span>Keyboard shortcuts</span>0
        ...
        <DropdownMenuRadioItem value="yo"></DropdownMenuRadioItem>
      </DropdownMenuContent>
    </DropdownMenu>
  );
}
